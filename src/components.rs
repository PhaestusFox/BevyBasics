        ...
        commands
            .spawn_bundle(PbrBundle {
                ...
                transform: Transform::from_translation(Vec3::new(
                    rng.gen_range(-world_size.0.x..world_size.0.x),
                    rng.gen_range(-world_size.0.y..world_size.0.y),
                    rng.gen_range(-world_size.0.z..world_size.0.z),
                ))
...
fn move_balls(
    ...
    for (mut transform, speed, mut direction) in balls.iter_mut() {
        ...
        transform.translation = transform
            .translation
            .clamp(-world_size.0 * 0.99, world_size.0 * 0.99);
    }
}
