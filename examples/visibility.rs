...
fn toggle_visibility(
    ...
    for key in input.get_just_pressed() {
        match key {
            KeyCode::Numpad0 => {set.insert(0);},
            KeyCode::Numpad1 => {set.insert(1);},
            KeyCode::Numpad2 => {set.insert(2);},
            KeyCode::Numpad3 => {set.insert(3);},
            KeyCode::Numpad4 => {set.insert(4);},
            KeyCode::Numpad5 => {set.insert(5);},
            KeyCode::Numpad6 => {set.insert(6);},
            KeyCode::Numpad7 => {set.insert(7);},
            KeyCode::Numpad8 => {set.insert(8);},
            KeyCode::Numpad9 => {set.insert(9);},
            _ => {},
        }
    }
...
const CUBE_COLORS: [Color; 10] = [
    ...
    Color::BLACK, Color::CRIMSON, Color::CYAN,
    Color::GOLD, Color::VIOLET, Color::WHITE,
    Color::ORANGE,
];
...
fn spawn_cube(
    ...
    for i in 0..10 {
        ...
        .insert(VisibilityExample(i as u8)).id();
        if i == 0 {
            last = e;
            continue;}
